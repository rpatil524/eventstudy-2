...
- [x] 02-03-PLAN.md — Time-varying/external: RollingWindow + GARCH/DCC pre-call guards only (failure wrapping stays Phase 3) (wave 3)
- [x] 02-04-PLAN.md — Test statistics: sigma==0 + n_events==1 guards; verify-and-lock joins/cumsum with regression tests (wave 1)
