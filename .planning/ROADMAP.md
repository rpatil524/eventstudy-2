...
- [ ] **Phase 1: Contract Foundation** - Define the degenerate-input contract and configurable strict/lenient mode; prove it on a reference model
...
|-------|----------------|--------|-----------|
| 1. Contract Foundation | 0/TBD | Not started | - |
