...
- [x] **Phase 8: Agent Skill + Waitlist + Green Check Gate** - Claude Code Agent Skill orchestrating the full advise loop, the commercial "Advisor Pro" waitlist surface, and a green `R CMD check` with the 1378-test suite still green (completed 2026-09-04)
